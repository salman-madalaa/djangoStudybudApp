...
def RegisterPage(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            user = form.save(commit=False) # here we put commit is false so it does not save in data base  and we can get the user object . Because we can change the user 
