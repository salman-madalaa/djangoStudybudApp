...
from studybuddy.forms import PersonForm,UserForm

def Home(request):
    return HttpResponse("This is Home Page give the url /room  For to see the output")
...
def RegisterPage(request):
    ...
    newRegistrationform = PersonForm()
    if request.method == 'POST':
    ...
    context= {'page':page,'registrationForm':registrationform,'newRegistrationform'}
    return render(request,'room/login_register.html',context)
